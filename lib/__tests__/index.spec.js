...
describe('mdLinks', () => {
  ...
  test('returns array of links, titles and status', () => {
    return mdLinks('lib/__tests__/teste.md', '--validate').then((result) => {
      expect(result).toEqual([ { href: 'https://www.google.com', texto: 'Link1', status: 200}, { href: 'https://nodejs.org/api/fs.html', texto: 'fs', status: 200}, { href: 'https://nodejs.org/api/path.html', texto: 'path', status: 200}, { href: 'https://www.facebook.com', texto: 'Link2', status: 200} ])
    })
  })
